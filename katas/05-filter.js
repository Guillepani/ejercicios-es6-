...
const streamers = [
 ...
 //Streamers que juegan al League of Legends
const lolStreamers = streamers.filter(
  streamer => streamer.gameMorePlayed === 'League of Legends'
);
console.log(lolStreamers);

// 5.4 Streamers que incluyen 'u' en el nombre
const uStreamers = streamers.filter(
  streamer => streamer.name.includes('u')
);
console.log(uStreamers);

// 5.5 Game incluye 'Legends' + MAYÚSCULAS si age > 35
